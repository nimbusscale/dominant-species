...
export class GameStateService {
  constructor(
    ...
    this.gameStateClient.gsp$.subscribe((gsp) => this.applyGsp(gsp))
  }
  ...
  commitTransaction(): void {
    if (this.gameStateStore.transactionState) {
      const gsp = this.gspService.create(this.gameStateStore.gameState, this.gameStateStore.transactionState)
