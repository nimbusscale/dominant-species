...
describe('AnimalService', () => {
  ...
  describe('added elements', () => {
    ...
    it('can add elements and emit', (done) => {
      ...
      animalService.addElement(defaultPieceFactory(ElementEnum.SUN) as ElementPiece);
    });
    it('can add remove and emit', (done) => {
      ...
      animalService.addElement(defaultPieceFactory(ElementEnum.SUN) as ElementPiece);
      animalService.removeElement(defaultPieceFactory(ElementEnum.SUN) as ElementPiece);
    });
    ...
    it('throws error if removing an element not added', () => {
      ...
      expect(() => {
        animalService.removeElement(defaultPieceFactory(ElementEnum.SEED) as ElementPiece);
      }).toThrowError();
    });
  });
});
